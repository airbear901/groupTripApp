...
define(".127.0.0.1", true); // to be replaced by '.mydomain.com'
...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "wolffaar@gmail.com");
define("EMAIL_SMTP_PASSWORD", "aaronw");
